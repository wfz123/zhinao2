...
public class PinYin4jUtil {
    ...
    public static void main(String[] args) {
        String str = "大家好，欢迎大家来到我们的java世界。";
        String py = PinYin4jUtil.getPinYin(str); //设置字母全小写
        System.out.println("字母全小写："+py);
        py = PinYin4jUtil.getPinYin(str, "3"); //设置每个字首字母大写
        System.out.println("每个字首字母大写："+py);
        py = PinYin4jUtil.getCnASCII(str); //将字符串转换成ASCII码
        System.out.println("将字符串转换成ASCII码："+py);
        py = PinYin4jUtil.getPinYinFristChar(str); //不传第二个参数，默认返回首字母的大写，第二参数传null则返回小写

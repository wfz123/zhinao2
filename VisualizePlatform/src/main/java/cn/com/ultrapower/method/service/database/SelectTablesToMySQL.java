...
import java.util.*;
/**
 * Created by wfz on 2018/10/10.公共查询表信息方法（MySQL库）
 */
@Service
public class SelectTablesToMySQL {
    static String DB_DRIVER = "";
    static String DB_URL = "";
    static String DB_UNAME = "";
    static String DB_PWD = "";
    public SelectTablesToMySQL(){
        initPath();
    }
    //查询某库所有表方法入口
    public Map executeAnalysis(Map paramMap){
        ...
        if(paramMap.containsKey("databaseName")) {
            ...
            if(StringUtils.isNotBlank(databaseName)) {
                String sql = "SELECT TABLE_NAME tableName,`ENGINE` databaseEngine FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = '"+databaseName+"'";
    ...
    public static void main(String [] args){
        ...
        System.out.println(new SelectTablesToMySQL().executeAnalysis(testMap));
    }
}
